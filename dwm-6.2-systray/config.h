...
static const char *fonts[]          = { "saucecodepro nerd font:size=10","siji:10", "MesloLGS NF:size=10","font awesome:size=10"};
...
static const char col_gray3[]       = "#cb9434";
